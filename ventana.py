...
class Ventana(Frame,Botones,Labels,Inputs):
    ...
    def create_widgets(self):
        ...
        Botones.agregar_boton("btn_create",frame1,"Create",Botones.crear,"blue","white",5,50,80,30)
        Botones.agregar_boton("btn_read",frame1,"Read",Botones.salir,"blue","white",5,90,80,30)
        Botones.agregar_boton("btn_update",frame1,"Update",Botones.salir,"blue","white",5,130,80,30)
        Botones.agregar_boton("btn_delete",frame1,"Delete",Botones.salir,"blue","white",5,170,80,30)
